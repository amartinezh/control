		...
		if (data != null) {
			for (Object[] d : data) {
					try {
						...
						listContratista.add(new Contratista(d[0].toString(), d[1].toString(), d[2].toString(), (TipoPersona) d[3], (Dependencia) d[4], d[5].toString(), d[6].toString(), d[7].toString() , (byte[]) d[8], d[9].toString(), d[10].toString(), d[11].toString(), formatter.parse(d[12].toString()), d[13].toString(), d[14].toString(), d[15].toString(), formatter.parse(d[16].toString()), d[17].toString(), formatter.parse(d[18].toString()), d[19].toString(), d[20].toString(), d[21].toString(),"1"));
