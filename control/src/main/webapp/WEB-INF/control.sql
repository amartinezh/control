...
(
  ...
  corfeo_e character varying(128),
...
CREATE TABLE nomina.trabajador(
  ...
  rotacion_id integer,
  puesto_id integer,
  correo_e character varying(128),
...
CREATE TABLE control.conductor(
  ...
  scan_orden_cargue text,
  scan_tarjeta_propiedad text,
  scan_arl character varying,
  observaciones text,
  estado character varying(1),
