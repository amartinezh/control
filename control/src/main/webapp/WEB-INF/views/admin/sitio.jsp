...
<body class="">
							...
							<div role="content">
								...
								<div class="widget-body">
									<form:form id="frm" method="post" class="bv-form"
										ModelAttribute="sitio" commandName="sitio">
											...
											<div class="form-group">
												<div class="row">
													<div class="col-md-12 has-feedback">
														<form:input type="hidden" path="sitio_id" value="0" />
					...
					<div class="widget-body no-padding">
						...
						<div id="datatable_fixed_column_wrapper"
							...
							<table id="datatable_fixed_column" name="datatable_fixed_column"
								...
								<tbody>
									<c:forEach items="${listSitio}" var="obj"
										varStatus="loopCounter">
										<tr role="row" class="odd">
											<td class="sorting_1"><span class="responsiveExpander"></span>
												<a class="btn btn-success btn-circle btn-sx"
												onclick="con('<c:out value="${obj.sitio_id}"></c:out>','<c:out value="${obj.descripcion}"></c:out>',$(this))"><i
													class="fa fa-edit"></i></a> <a
												class="btn btn-danger btn-circle"
												onclick="borrar(<c:out value="${obj.sitio_id}"></c:out>, $(this))"><i
	...
	<script type="text/javascript">
		...
		function actualizar() {
			$( "#frm" ).submit();
			var acti_id = document.getElementById('sitio_id').value;
		...
		function cancelar() {
			var obj_id = document.getElementById('sitio_id').value;
		...
		function con(acti_id, descripcion, thi) {
			document.getElementById('sitio_id').value=acti_id;
