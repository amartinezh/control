...
<body class="">
							...
							<div role="content">
								...
								<div class="widget-body">
									<form:form id="frm" method="post" class="bv-form"
										ModelAttribute="tipoPersona" commandName="tipoPersona">
											...
											<div class="form-group">
												<div class="row">
													<div class="col-md-12 has-feedback">
														<form:input type="hidden" path="tipo_persona_id" value="0" />
					...
					<div class="widget-body no-padding">
						...
						<div id="datatable_fixed_column_wrapper"
							...
							<table id="datatable_fixed_column" name="datatable_fixed_column"
								...
								<tbody>
									<c:forEach items="${listTipoPersona}" var="obj"
										varStatus="loopCounter">
										<tr role="row" class="odd">
											<td class="sorting_1"><span class="responsiveExpander"></span>
												<a class="btn btn-success btn-circle btn-sx"
												onclick="con('<c:out value="${obj.tipo_persona_id}"></c:out>','<c:out value="${obj.descripcion}"></c:out>',$(this))"><i
													class="fa fa-edit"></i></a> <a
												class="btn btn-danger btn-circle"
												onclick="borrar(<c:out value="${obj.tipo_persona_id}"></c:out>, $(this))"><i
	...
	<script type="text/javascript">
		...
		function actualizar() {
			$( "#frm" ).submit();
			var acti_id = document.getElementById('tipo_persona_id').value;
			var des = document.getElementById('descripcion').value;
			$.ajax({
				type : "POST",
				url : "tipopersona/agregar",
				data : {
					tipo_persona_id: acti_id,
					descripcion : des
				},
				success : function(data) {			
					 document.getElementById('descripcion').value = "";
					 document.getElementById('tipo_persona_id').value = "0";
					 var res = data.split(":::");
		...
		function del(dato, thi) {
			$.ajax({
				type : "POST",
				url : "tipopersona/borrar",
				data : {
					tipo_persona_id : dato
				},
				success : function(data) {
		...
		function cancelar() {
			var obj_id = document.getElementById('tipo_persona_id').value;
			var des = document.getElementById('estado').value;
			$('#elboton').text('Nuevo');
			$.ajax({
				type : "POST",
				url : "tipopersona/cancelar",
				data : {
					tipo_persona_id: obj_id,
					descripcion : des
				},
				success : function(data) {					
					document.getElementById('descripcion').value = "";
		...
		function con(acti_id, descripcion, thi) {
			document.getElementById('tipo_persona_id').value=acti_id;
