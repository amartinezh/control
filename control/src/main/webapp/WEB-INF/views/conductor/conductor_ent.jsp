		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<div class="jarviswidget" id="wid-id-0"
					...
					<header>
						<h2>Registro Ingreso Conductores</h2>
					</header>
							...
							<form id="frm" method="post">
										...
										<div class="row">
											...
											<div class="col-sm-12 col-md-4">
												<label class="control-label">Placa</label> <input
													type="text" class="form-control" name="placa" />
											</div>
											<div class="col-sm-12 col-md-4">
								...
								<fieldset>
									<div class="form-group">
										<div class="row">
											...
											<div class="col-sm-12 col-md-4">
												<label class="control-label">Documento Patiero</label> <input
								...
								<fieldset>
									<div class="form-group">
										<div class="row">
											<div class="col-md-4">
												<label class="control-label">Archivo Orden Cargue</label> <input
													type="file" class="form-control" name="foto_scan" />
											</div>
											<div class="col-md-4">
												<label class="control-label input-file">Archivo Tarjeta Propiedad</label> <input
													type="file" class="form-control" name="cedula_scan" />
											</div>
											<div class="col-md-4">
												<label class="control-label">Archivo ALR</label> <input
													type="file" class="form-control" name="huella_scan" />
											</div>
										</div>
									</div>
