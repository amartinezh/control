...
<body class="">
	...
	<!-- <script src="<c:url value="/resources/js/pdf/compatibility.js" />"></script>
	<script src="<c:url value="/resources/js/pdf/l10n.js" />"></script> -->
	
	
	<!--
	<script src="<c:url value="/resources/js/pdf/debugger.js" />"></script>
	<script src="<c:url value="/resources/js/pdf/viewer.js" />"></script>
	
	 	
	<script src="<c:url value="/resources/js/pdf/fonts.js" />"></script>
	<script src="<c:url value="/resources/js/pdf/glyphlist.js.js" />"></script>  --> 
	
	
	<!-- <script src="<c:url value="/resources/js/pdf/build/pdf.js" />"></script>
	<script src="<c:url value="/resources/js/pdf/build/pdf.worker.js" />"></script>
	  <script src="<c:url value="/resources/js/pdf/worker_loader.js" />"></script>  -->
		...
		function readImage() {
		    if ( this.files && this.files[0] ) {
		        ...
		        FR.onload = function(e) {
		           ...
		           //PDFJS.workerSrc = '<c:url value="/resources/js/pdf/worker_loader.js" />';
  ...
  <head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/js/pdf/web/viewer.css" />"/>

	<script src="<c:url value="/resources/js/pdf/web/compatibility.js" />"></script>


<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="<c:url value="/resources/js/pdf/web/locale/locale.properties" />"/>
<script src="<c:url value="/resources/js/pdf/web/l10n.js" />"></script>
<script src="<c:url value="/resources/js/pdf/build/pdf.js" />"></script>

<script src="<c:url value="/resources/js/pdf/web/debugger.js" />"></script>
<script src="<c:url value="/resources/js/pdf/web/viewer.js" />"></script>
