													...
													<div class="col-md-4">
														<label class="control-label">Tipo Producto</label>
														 <form:input path="nombre_completo" type="text"
															class="form-control" data-bv-field="Tipo Producto"
															required="required" />
													</div>
													<div class="col-md-4">
											...
											<div class="form-group">
												<div class="row">
													<div class="col-md-6 selectContainer">
														...
														<form:select class="form-control" path="tipo_producto_id.tipo_producto_id" items="${tipoproductoList}">
														</form:select>
													</div>
