...
<html>
	<head>
		...
		<link rel="apple-touch-startup-image" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:landscape)" href="<c:url value="/resources/img/splash/ipad-landscape.png" />" >
		<link rel="apple-touch-startup-image" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:portrait)" href="<c:url value="/resources/img/splash/ipad-portrait.png" />" >
		<link rel="apple-touch-startup-image" media="screen and (max-device-width: 320px)" href="<c:url value="/resources/img/splash/iphone.png" />" >
	...
	<body class="">
		...
		<header id="header">
			<div id="logo-group">
				...
				<span id="logo"> <img style="width: 200px; height: 30px;" src="<c:url value="/resources/img/logo.png" />" alt="SmartAdmin"> </span>
			...
			<nav>
				<ul>
					...
					<li>
						...
						<ul>
							<li><a target="des" href="<c:url value="/contratista_add"/>"><i class="fa fa-mail-forward"></i>
								Dar de alta</a></li>
							<li><a target="des" href="<c:url value="/contratista_add/hi"/>"><i class="fa fa-mail-reply"></i>
								Habilitar salida</a></li>
							<li><a target="des" href="<c:url value="/contratista_add/hs"/>"><i class="fa fa-mail-reply"></i>
								Habilitar salida</a></li>
						</ul>
					</li>
					<li>
					...
					<li>
						...
						<span class="menu-item-parent">Transportes</span></a>
						<ul>
							<li>
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<span class="ribbon-button-alignment"> 
					<span id="refresh" class="btn btn-ribbon" data-action="resetWidgets" data-title="refresh"  rel="tooltip" data-placement="bottom" data-original-title="<i class='text-warning fa fa-warning'></i> Adevertencia! ésto recargará la página y se perderán datos." data-html="true">
			...
			<div id="content">
				...
				<iframe id="des" name="des" width="100%" height="900" frameborder="0" allowfullscreen></iframe>
		...
		<script>
			if (!window.jQuery) {
				document.write('<script src="<c:url value="/resources/js/libs/jquery-2.1.1.min.js" />"><\/script>');
			}
		</script>
